 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const JP=new ke(G.comparator);function Hn(){return JP}const PT=new ke(G.comparator);function lo(...t){let e=PT;for(const n of t)e=e.insert(n.key,n);return e}function NT(t){let e=PT;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function Qr(){return Io()}function xT(){return Io()}function Io(){return new yi(t=>t.toString(),(t,e)=>t.isEqual(e))}const XP=new ke(G.comparator),ZP=new ze(G.comparator);function oe(...t){let e=ZP;for(const n of t)e=e.add(n);return e}const eN=new ze(se);function tN(){return eN}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
